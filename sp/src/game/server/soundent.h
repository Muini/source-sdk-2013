...
#define SOUNDENT_VOLUME_SNIPER		4000.0
#define SOUNDENT_VOLUME_MACHINEGUN	2400.0
#define SOUNDENT_VOLUME_SHOTGUN		2000.0
#define SOUNDENT_VOLUME_PISTOL		1800.0
#define SOUNDENT_VOLUME_SILENCER	1000.0
#define SOUNDENT_VOLUME_EMPTY		 200.0 // volume of the "CLICK" when you have no bullets
