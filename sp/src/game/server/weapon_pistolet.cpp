...
class CWeaponPistolet : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();

public:
	DECLARE_CLASS( CWeaponPistolet, CBaseHLCombatWeapon );

	CWeaponPistolet(void);
	...
	virtual const Vector& GetBulletSpread( void )
	{
		...
		if ( pistolet_use_new_accuracy.GetBool() )
		{
...
IMPLEMENT_SERVERCLASS_ST(CWeaponPistolet, DT_WeaponPistolet)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_pistolet, CWeaponPistolet );
PRECACHE_WEAPON_REGISTER( weapon_pistolet );

BEGIN_DATADESC( CWeaponPistolet )
...
acttable_t	CWeaponPistolet::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE( CWeaponPistolet );

//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponPistolet::CWeaponPistolet( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponPistolet::Precache( void )
{
	BaseClass::Precache();
}
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponPistolet::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponPistolet::DryFire( void )
{
	WeaponSound( EMPTY );
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponPistolet::PrimaryAttack( void )
{
	...
	if( pOwner )
	{
		// Each time the player fires the pistoletet, reset the view punch. This prevents
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponPistolet::UpdatePenaltyTime( void )
{
	CBasePlayer *pOwner = ToBasePlayer( GetOwner() );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponPistolet::ItemPreFrame( void )
{
	UpdatePenaltyTime();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponPistolet::ItemBusyFrame( void )
{
	UpdatePenaltyTime();
...
//-----------------------------------------------------------------------------
void CWeaponPistolet::ItemPostFrame( void )
{
...
// Output : int
//-----------------------------------------------------------------------------
Activity CWeaponPistolet::GetPrimaryAttackActivity( void )
{
	/*
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
bool CWeaponPistolet::Reload( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponPistolet::AddViewKick( void )
{
	CBasePlayer *pPlayer  = ToBasePlayer( GetOwner() );
