...
class C_Arrow : public C_BaseCombatCharacter
{
	DECLARE_CLASS( C_Arrow, C_BaseCombatCharacter );
	DECLARE_CLIENTCLASS();
public:
...
private:
	...
	C_Arrow( const C_Arrow & ); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT( C_Arrow, DT_Arrow, CArrow )
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_Arrow::C_Arrow( void )
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_Arrow::OnDataChanged( DataUpdateType_t updateType )
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_Arrow::DrawModel( int flags )
{
