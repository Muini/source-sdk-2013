...
ConVar cl_sunlight_ortho_size("cl_sunlight_ortho_size", "2000.0", FCVAR_CHEAT, "Set to values greater than 0 for ortho view render projections.");
ConVar cl_sunlight_depthbias( "cl_sunlight_depthbias", "0.0005" );
