...
ConVar	sv_noclipspeed	( "sv_noclipspeed", "6", FCVAR_ARCHIVE | FCVAR_NOTIFY | FCVAR_REPLICATED);
...
ConVar	sv_maxspeed		( "sv_maxspeed", "420", FCVAR_NOTIFY | FCVAR_REPLICATED);
#else
ConVar	sv_maxspeed		( "sv_maxspeed", "420", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY);
#endif // CSTRIKE_DLL
...
#else
ConVar	sv_airaccelerate(  "sv_airaccelerate", "15", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY );    
