...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_BARNACLE,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_COMBINE,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_PROTOSNIPER,		D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE,	CLASS_PLAYER_ALLY_VITAL,D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_ANTLION,			D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_BARNACLE,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_CITIZEN_REBEL,	D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_COMBINE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_COMBINE_GUNSHIP,	D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_HEADCRAB,			D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_SCANNER,			D_FR, 0);		
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_PLAYER_ALLY,		D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,		CLASS_PLAYER_ALLY_VITAL,D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_BARNACLE,			D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_HEADCRAB,			D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,			CLASS_ZOMBIE,			D_FR, 0);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		bInitted = true;
		//Simple Ammo
		def.AddAmmoType("Pellet_S",			DMG_BULLET | DMG_BUCKSHOT,	TRACER_SUPERS,	"sk_dmg_pellet_s",		"sk_dmg_npc_pellet_s",		"sk_max_pellet_s", BULLET_SPEED(2000),		BULLET_IMPULSE(123, 1390), 0 ); //Small Pellet
		def.AddAmmoType("Pellet_M",			DMG_BULLET,					TRACER_SUBS,	"sk_dmg_pellet_m",		"sk_dmg_npc_pellet_m",		"sk_max_pellet_m",	BULLET_SPEED(1750),	BULLET_IMPULSE(185, 2085), 0 ); //Medium/Normal Pellet
		def.AddAmmoType("Pellet_L",			DMG_BULLET | DMG_BIG,		TRACER_BIG,		"sk_dmg_pellet_l",		"sk_dmg_npc_pellet_l",		"sk_max_pellet_l",	BULLET_SPEED(1500),	BULLET_IMPULSE(246, 2780), 0 ); //Large/Heavy Pellet
		def.AddAmmoType("Pellet_XL",		DMG_BLAST | DMG_BURN,		TRACER_NONE,			"sk_dmg_pellet_xl",		"sk_dmg_npc_pellet_xl",		"sk_max_pellet_xl",	BULLET_SPEED(1000),	0, 0 ); //Canon Round
		def.AddAmmoType("Arrow",			DMG_BULLET | DMG_SLASH,		TRACER_NONE,			"sk_dmg_arrow",			"sk_dmg_npc_arrow",			"sk_max_arrow",	BULLET_SPEED(1000),		BULLET_IMPULSE(200, 2000), 0 ); //Arrow for bow
		def.AddAmmoType("CrossbowBolt",		DMG_BULLET | DMG_SLASH,		TRACER_NONE,			"sk_dmg_crossbowbolt",	"sk_dmg_npc_crossbowbolt",	"sk_max_crossbowbolt",	BULLET_SPEED(1000), BULLET_IMPULSE(300, 3000), 0 );	//Crossbow Bolt
		//Special Ammo
		def.AddAmmoType("Pellet_M_HE",		DMG_BULLET | DMG_BLAST,		TRACER_SUBS,	"sk_dmg_pellet_m",		"sk_dmg_npc_pellet_m",	"sk_max_pellet_m",	BULLET_SPEED(1750),	BULLET_IMPULSE(185, 2085), 0 ); //Medium/Normal Explosive Pellet
		def.AddAmmoType("Pellet_M_I",		DMG_BULLET | DMG_BURN,		TRACER_FIRE,	"sk_dmg_pellet_m",		"sk_dmg_npc_pellet_m",		"sk_max_pellet_m",	BULLET_SPEED(1750),	BULLET_IMPULSE(185, 2085), 0 ); //Medium/Normal Incendiary Pellet
		def.AddAmmoType("Pellet_SM",		DMG_BULLET | DMG_PERFORANT,	TRACER_SUPERS,	"sk_dmg_pellet_sm",		"sk_dmg_npc_pellet_sm",		"sk_max_pellet_sm",	BULLET_SPEED(2250),	BULLET_IMPULSE(185, 2085), 0 ); //Spiky Pellet
		def.AddAmmoType("Pellet_L_HE",		DMG_BULLET | DMG_BLAST,		TRACER_BIG,		"sk_dmg_pellet_l",		"sk_dmg_npc_pellet_l",		"sk_max_pellet_l",	BULLET_SPEED(1500),	BULLET_IMPULSE(246, 2780), 0 ); //Large/Heavy Explosive Pellet
		def.AddAmmoType("Fireball",			DMG_BURN,					TRACER_FIRE,			"sk_dmg_fireball",		"sk_dmg_npc_fireball",		"sk_max_fireball",	BULLET_SPEED(1000),	BULLET_IMPULSE(246, 2780), 0 ); //Fireball
		def.AddAmmoType("ElecBullet",		DMG_BURN | DMG_SHOCK,		TRACER_BEAM,			"sk_dmg_elecbullet",	"sk_dmg_npc_elecbullet",	"sk_max_elecbullet", BULLET_SPEED(2000), BULLET_IMPULSE(246, 2780), 0 ); //Electrical Bullet
		//Standar hl2 Ammo
		def.AddAmmoType("AR2",				DMG_BULLET,					TRACER_GREEN,				"sk_plr_dmg_ar2",			"sk_npc_dmg_ar2",			"sk_max_ar2",	BULLET_SPEED(2500),		BULLET_IMPULSE(120, 2360), 0 ); //
		def.AddAmmoType("AlyxGun",			DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_alyxgun",		"sk_npc_dmg_alyxgun",		"sk_max_alyxgun",	BULLET_SPEED(1750),	BULLET_IMPULSE(125, 1450), 0 ); //
		def.AddAmmoType("Pistol",			DMG_BULLET,					TRACER_SUPERS,	"sk_plr_dmg_pistol",		"sk_npc_dmg_pistol",		"sk_max_pistol",	BULLET_SPEED(1750),	BULLET_IMPULSE(155, 1200), 0 ); //.40 S&W
		def.AddAmmoType("SMG1",				DMG_BULLET,					TRACER_SUPERS,	"sk_plr_dmg_smg1",			"sk_npc_dmg_smg1",			"sk_max_smg1",	BULLET_SPEED(2000),		BULLET_IMPULSE(25,	2370), 0 ); //5,7 × 28 mm
		def.AddAmmoType("SMG2",				DMG_BULLET | DMG_BLAST,		TRACER_BIG,	"sk_plr_dmg_smg2",			"sk_npc_dmg_smg2",			"sk_max_smg2",	BULLET_SPEED(1500),		BULLET_IMPULSE(400,	2500), 0 ); //5,7 × 28 mm
		def.AddAmmoType("357",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_357",			"sk_npc_dmg_357",			"sk_max_357",	BULLET_SPEED(1500),		BULLET_IMPULSE(230*6.0f, 935), 0 ); //.45 ACP
		def.AddAmmoType("XBowBolt",			DMG_BULLET,					TRACER_LINE,			"sk_plr_dmg_crossbow",		"sk_npc_dmg_crossbow",		"sk_max_crossbow",	BULLET_SPEED(1000),	BULLET_IMPULSE(200, 2000), 0 );
		def.AddAmmoType("Buckshot",			DMG_BULLET | DMG_BUCKSHOT,	TRACER_SUBS,	"sk_plr_dmg_buckshot",		"sk_npc_dmg_buckshot",		"sk_max_buckshot",	BULLET_SPEED(1500),	BULLET_IMPULSE(123*6.0f, 1390), 0 ); //12 Gauge
		def.AddAmmoType("RPG_Round",		DMG_BLAST | DMG_BURN,		TRACER_NONE,			"sk_plr_dmg_rpg_round",		"sk_npc_dmg_rpg_round",		"sk_max_rpg_round",	BULLET_SPEED(1000),	0, 0 );
		def.AddAmmoType("SMG1_Grenade",		DMG_BLAST | DMG_BURN,		TRACER_NONE,			"sk_plr_dmg_smg1_grenade",	"sk_npc_dmg_smg1_grenade",	"sk_max_smg1_grenade",	BULLET_SPEED(1000), 0, 0 );
		def.AddAmmoType("SniperRound",		DMG_BULLET | DMG_SNIPER | DMG_BIG,	TRACER_BIG,			"sk_plr_dmg_sniper_round",	"sk_npc_dmg_sniper_round",	"sk_max_sniper_round", BULLET_SPEED(2000),	BULLET_IMPULSE(655*6.0f, 3030), 0 ); //.50
		def.AddAmmoType("SniperPenetratedRound", DMG_BULLET | DMG_SNIPER | DMG_BIG | DMG_PERFORANT, TRACER_BIG,			"sk_dmg_sniper_penetrate_plr", "sk_dmg_sniper_penetrate_npc", "sk_max_sniper_round", BULLET_SPEED(3000), BULLET_IMPULSE(800*6.0f, 2900), 0 ); //.50 Louder
		def.AddAmmoType("Grenade",			DMG_BLAST | DMG_BURN,		TRACER_NONE,			"sk_plr_dmg_grenade",		"sk_npc_dmg_grenade",		"sk_max_grenade", BULLET_SPEED(1000),		0, 0);
		def.AddAmmoType("Thumper",			DMG_SONIC,					TRACER_NONE,			10, 10, 2, BULLET_SPEED(1000), 0, 0 );
		def.AddAmmoType("Gravity",			DMG_CLUB,					TRACER_NONE,			0,	0, 8, BULLET_SPEED(1000), 0, 0 );
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, BULLET_SPEED(1000), 0, 0 );
		def.AddAmmoType("Battery",			DMG_CLUB,					TRACER_NONE,			NULL, NULL, NULL, BULLET_SPEED(1000), 0, 0 );
		def.AddAmmoType("GaussEnergy",		DMG_SHOCK | DMG_BURN,		TRACER_BEAM,			"sk_jeep_gauss_damage",		"sk_jeep_gauss_damage", "sk_max_gauss_round", BULLET_SPEED(3000), BULLET_IMPULSE(650, 8000), 0 ); // hit like a 10kg weight at 400 in/s
		def.AddAmmoType("CombineCannon",	DMG_BULLET | DMG_SHOCK,		TRACER_BEAM,			"sk_npc_dmg_gunship_to_plr", "sk_npc_dmg_gunship", NULL, BULLET_SPEED(2000), 1.5 * 750 * 12, 0 ); // hit like a 1.5kg weight at 750 ft/s
		def.AddAmmoType("AirboatGun",		DMG_AIRBOAT,				TRACER_GREEN,			"sk_plr_dmg_airboat",		"sk_npc_dmg_airboat",		NULL, BULLET_SPEED(2000),					BULLET_IMPULSE(10, 600), 0 );
		def.AddAmmoType("StriderMinigun",	DMG_BULLET,					TRACER_RED,			5, 5, 15, BULLET_SPEED(2000), 1.0 * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
		def.AddAmmoType("StriderMinigunDirect",	DMG_BULLET,				TRACER_RED,			2, 2, 15, BULLET_SPEED(2000), 1.0 * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 1.0kg weight at 750 ft/s
		def.AddAmmoType("HelicopterGun",	DMG_BULLET,					TRACER_SUBS,			"sk_npc_dmg_helicopter_to_plr", "sk_npc_dmg_helicopter",	"sk_max_smg1", BULLET_SPEED(1750),	BULLET_IMPULSE(400, 1225), AMMO_FORCE_DROP_IF_CARRIED | AMMO_INTERPRET_PLRDAMAGE_AS_DAMAGE_TO_PLAYER );
		def.AddAmmoType("AR2AltFire",		DMG_DISSOLVE,				TRACER_NONE,			0, 0, "sk_max_ar2_altfire", BULLET_SPEED(1000), 0, 0 );
		def.AddAmmoType("Grenade",			DMG_BURN | DMG_BLAST,		TRACER_NONE,			"sk_plr_dmg_grenade",		"sk_npc_dmg_grenade",		"sk_max_grenade", BULLET_SPEED(1000),		0, 0);
#ifdef HL2_EPISODIC
		def.AddAmmoType("Hopwire",			DMG_BLAST,					TRACER_NONE,			"sk_plr_dmg_grenade",		"sk_npc_dmg_grenade",		"sk_max_hopwire", BULLET_SPEED(1000),		0, 0);
		def.AddAmmoType("CombineHeavyCannon",	DMG_BULLET | DMG_SHOCK,	TRACER_BEAM,			40,	40, NULL, BULLET_SPEED(1500), 10 * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 10 kg weight at 750 ft/s
		def.AddAmmoType("ammo_proto1",			DMG_BULLET,				TRACER_LINE,			0, 0, 10, BULLET_SPEED(1225), 0, 0 );
#endif // HL2_EPISODIC
	}
